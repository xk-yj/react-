...
import { PopoverProps, NativePopoverProps } from './interface';
const Input: FC<PopoverProps & NativePopoverProps> = memo(
  ({ title, content, width, children, trigger, placement }) => {
